        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center w-full max-w-md mx-auto space-y-6">
            ...
            <div className="space-y-2 pt-2">
              ...
              <div 
                style={{ color: contentColor, fontSize: `${contentSize}px` }}
                className="leading-relaxed font-medium space-y-0.5"
              >
                <p style={{ color: '#ffffff', fontSize: `${parseInt(contentSize) + 2}px` }} className="font-bold">{addressStreet}</p>
                <p className="opacity-80">{addressDetails}</p>
                <p className="opacity-80">{addressCity}</p>
              </div>
            </div>
